...
import { GET_LEI_MICROFINANCAS } from '../graphql/queries';



function LeiMicrofinancas() {


    const { data, loading, error } = useQuery(GET_LEI_MICROFINANCAS);

    if (loading) { return true }
    if (error) { return false }
    
    const attr = data.leiDeMicrofinanca.data.attributes
...
export default LeiMicrofinancas
